        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="portfolio-info">
              <h3>Данные по новости</h3>
              <ul>
                <li><strong>Рубрика</strong>{{ $news->category }}</li>
                <li><strong>Дата</strong>{{ $news->created_at }}</li>
                <li><a href="{{ route('news') }}" class="btn-visit align-self-start">Все новости</a></li>
              </ul>
            </div>
          </div>
        </div>
