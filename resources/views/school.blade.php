...
<head>
  ...
  <title>ICTC - Казахстанско-немецкая школа</title>
...
<section id="portfolio-details" class="team section light-background">
    ...
    <div class="row gy-4">
        @foreach ($news2 as $school => $post)
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="{{ ($school + 1) * 100 }}">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function () {
                let checkedCount = document.querySelectorAll('.limit-check:checked').length;
                if (checkedCount > 3) {
                    this.checked = false; // Отменяем выбор, если больше 3
                    alert('Вы можете выбрать не более 3 вариантов.');
                }
            });
        });
    });
