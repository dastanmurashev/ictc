...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flexh align-items-center" style="display: flex;">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a href="/school">{{ __('menu.school') }}</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="assets/img/hero-bg-abstract.png" alt="" data-aos="fade-in" class="">

      <div class="container col-xl-7 col-lg-9">
        <div class="row" data-aos="zoom-out">
          <div>
              <h1>{{ __('home.main_title') }}</h1>
              <h1>{{ __('home.subtitle') }}</h1>
              <p>{{ __('home.description') }}</p>
          </div>
        </div>
        <div data-aos="zoom-out" data-aos-delay="100">
          <a href="/about" class="btn-get-started">{{ __('home.about') }}</a>
        </div>
        </div>
      </div>
    ...
    <section id="call-to-action" class="call-to-action section accent-background">
      ...
      <div class="container">
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <h2 style="color: #fff !important;display: flex;justify-content: center;margin-bottom: 60px;">{{ __('home.our_projects') }}</h2>
            <div class="serv">
              <div>
                  <h4>{{ __('home.school_project') }}</h4>
              </div>
              <div>
                  <a class="cta-btn" href="#">{{ __('home.presentation') }}</a>
                  <a class="cta-btn" href="/school">{{ __('home.read_more') }}</a>
              </div>
            </div>
            <div class="serv">
              <div>
                  <h4>{{ __('home.trenchless_repair') }}</h4>
              </div>
              <div>
                  <a class="cta-btn" href="/storage/buklet.pdf">{{ __('home.presentation') }}</a>
                  <a class="cta-btn" href="/profile">{{ __('home.read_more') }}</a>
            </div>
            </div>
        </div>
      </div>
...
<section id="services" class="services section light-background">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item item-cyan position-relative">
          <a href="/services" class="stretched-link">
              <h3>{{ __('home.services.strategy_invest') }}</h3>
          </a>
        </div>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item item-orange position-relative">
          ...
          <a href="/services" class="stretched-link">
              <h3>{{ __('home.services.business_support') }}</h3>
          </a>
        </div>
      </div><!-- End Service Item -->
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
        <div class="service-item item-red position-relative">
          ...
          <a href="/services" class="stretched-link">
              <h3>{{ __('home.services.digital_transformation') }}</h3>
          </a>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
        <div class="service-item item-indigo position-relative">
          ...
          <a href="/services " class="stretched-link">
              <h3>{{ __('home.services.strategic_comms') }}</h3>
          </a>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
        <div class="service-item item-pink position-relative">
          ...
          <a href="/services" class="stretched-link">
              <h3>{{ __('home.services.competence_dev') }}</h3>
          </a>
  ...
  <!-- NEWS Section -->
  <section id="news" class="news team section light-background">

    <!-- Section Title -->
    <div class="container section-title" data-aos="fade-up">
      <h2>{{ __('home.all_news') }}</h2>
...
<div class="container">
    <div class="row gy-4">
        @foreach ($news as $index => $post)
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                <div class="team-member">
                    <div class="member-img">
                        <!-- Пример для изображения новости -->
                        <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <h4>{{ $post->title }}</h4>
                        <p>{{ $post->created_at }}</p>
                        <a href="{{ route('news.show', $post->id) }}">Читать далее</a>  <!-- Ссылка на полную новость -->
                    </div>
                </div>
            </div><!-- End Team Member -->
        @endforeach
  ...
  <section id="call-to-action" class="call-to-action section accent-background" style="padding: 0 0 27px 0px !important;">
      <div class="container">
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          
            <div class="serv" style="display: flex; justify-content: center;">
              <div>
                  <a class="cta-btn" href="/news">{{ __('home.all_news') }}</a>
            </div>
            </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/04-removebg-preview.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/0404-removebg-preview.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/agmp-removebg-preview.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/atameken-removebg-preview.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/b25a9e17-fe1c-5874-fb03-f70fd78b154d-removebg-preview.png" class="img-fluid" alt="">
          </div><!-- End Client Item -->

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/ec9dfae4-6ba9-5cc9-efc4-e773c12f369a-removebg-preview.png" class="img-fluid" alt="">
          </div>
			
			<div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="assets/img/clients/of.png" class="img-fluid" alt="">
          </div>

            <div class="col-xl-2 col-md-3 col-6 client-logo">
                <img src="assets/img/clients/86aacc78-bae3-f3d5-b05f-d6ca41888114.png" class="img-fluid" alt="">
            </div><!-- End Client Item -->
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-about">
          <div class="logo">
            <img src="assets/img/ictc-logo-01.svg" alt="" class="">
          </div>
          <div class="social-links d-flex mt-4">
            <a target="_blank" href="https://www.facebook.com/share/1BXpUxkKZm/?mibextid=wwXIfr"><i class="bi bi-facebook"></i></a>
            <a target="_blank" href="https://www.instagram.com/ictc.kz?igsh=N3M0cDZzZ2UyaTdp&utm_source=qr"><i class="bi bi-instagram"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 footer-contact text-center text-md-start">
          <h4>{{ __('footer.contacts') }}</h4>
			...
			<p><strong>{{ __('footer.phone') }}:</strong> <span> +7 777 522 0767 </span></p>
            <p><strong>{{ __('footer.email') }}:</strong> <span>info@ictc.kz</span></p>
        </div>
