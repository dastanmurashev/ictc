...
<head>
  ...
  <title>ICTC - Новости проекта</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="team-member">
                    ...
                    <div class="member-info">
                        <h4>{{ $post->title }}</h4>
                        <p>{{ $post->created_at }}</p>
                       <!-- <div>{{ Str::limit($post->description, 100) }}</div> Описание ограничено 100 символами -->
      ...
      <div class="container footer-top">
          <div class="row gy-4">
              <div class="col-lg-5 col-md-12 footer-about">
                  <div class="logo">
                      <img src="{{ asset('assets/img/ictc-logo-01.svg') }}" alt="" class="">
                  </div>
